<template>
    <div>
        <div class="container">
     <router-link to="/" class="mx-auto my-3 btn btn-primary">Go Back</router-link>
      <ul class="list-group list-group-flush">
        <li class="list-group-item">
		<h2 id="tou">Attribution</h2>
<p>Thanks to our professors for letting us use them as a template</p>
          <h2 id="tou">Website Terms of Use</h2>

          <p>Version 1.0</p>

          <p>
            The SAI website located at SAI is a
            copyrighted work belonging to SAI. Certain features of
          ...
          <p>
            ...
            Notice to the Company should be sent to: SAI. After the
          ...
          <p>
            <strong
              >Additional Rules for Non-Appearance Based Arbitration.</strong
            >
        ...
        <li class="list-group-item">
          <h2 id="eula">End-User License Agreement (EULA) of <span class="app_name">SAI</span></h2>

<p>This End-User License Agreement ("EULA") is a legal agreement between you and <span class="company_name">SAI</span>. Our EULA was created by <a href="https://www.eulatemplate.com">EULA Template</a> for <span class="app_name">SAI</span>.</p>

<p>This EULA agreement governs your acquisition and use of our <span class="app_name">SAI</span> software ("Software") directly from <span class="company_name">SAI</span> or indirectly through a <span class="company_name">SAI</span> authorized reseller or distributor (a "Reseller"). Our Privacy Policy was created by <a href="https://www.generateprivacypolicy.com/">the Privacy Policy Generator</a>.</p>

<p>Please read this EULA agreement carefully before completing the installation process and using the <span class="app_name">SAI</span> software. It provides a license to use the <span class="app_name">SAI</span> software and contains warranty information and liability disclaimers.</p>

<p>If you register for a free trial of the <span class="app_name">SAI</span> software, this EULA agreement will also govern that trial. By clicking "accept" or installing and/or using the <span class="app_name">SAI</span> software, you are confirming your acceptance of the Software and agreeing to become bound by the terms of this EULA agreement.</p>

<p>If you are entering into this EULA agreement on behalf of a company or other legal entity, you represent that you have the authority to bind such entity and its affiliates to these terms and conditions. If you do not have such authority or if you do not agree with the terms and conditions of this EULA agreement, do not install or use the Software, and you must not accept this EULA agreement.</p>

<p>This EULA agreement shall apply only to the Software supplied by <span class="company_name">SAI</span> herewith regardless of whether other software is referred to or described herein. The terms also apply to any <span class="company_name">SAI</span> updates, supplements, Internet-based services, and support services for the Software, unless other terms accompany those items on delivery. If so, those terms apply.</p>

<h3>License Grant</h3>

<p><span class="company_name">SAI</span> hereby grants you a personal, non-transferable, non-exclusive licence to use the <span class="app_name">SAI</span> software on your devices in accordance with the terms of this EULA agreement.</p>

<p>You are permitted to load the <span class="app_name">SAI</span> software (for example a PC, laptop, mobile or tablet) under your control. You are responsible for ensuring your device meets the minimum requirements of the <span class="app_name">SAI</span> software.</p>
...
<li>use the Software for any purpose that <span class="company_name">SAI</span> considers is a breach of this EULA agreement</li>
</ul>

<h3>Intellectual Property and Ownership</h3>

<p><span class="company_name">SAI</span> shall at all times retain ownership of the Software as originally downloaded by you and all subsequent downloads of the Software by you. The Software (and the copyright, and other intellectual property rights of whatever nature in the Software, including any modifications made thereto) are and shall remain the property of <span class="company_name">SAI</span>.</p>

<p><span class="company_name">SAI</span> reserves the right to grant licences to use the Software to third parties.</p>

<h3>Termination</h3>

<p>This EULA agreement is effective from the date you first use the Software and shall continue until terminated. You may terminate it at any time upon written notice to <span class="company_name">SAI</span>.</p>
...
<h2>Contact Information</h2>
          <p>Name: Maximilian Blam, Moritz Miedler & Ahmed Hasanovic</p>
          <p>Email: blam.m03@htlwienwest.at</p>
          <p>Email: miedler.m03@htlwienwest.at</p>    
          <p>Email: hasanovic.a02@htlwienwest.at</p>    
</li>
      </ul>
    </div>
    </div>
