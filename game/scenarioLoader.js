...
function returnScenario(id) {
  ...
  newStack1[0].visible = true;
  newStack2[0].visible = true;
  newStack3[0].visible = true;
  newStack4[0].visible = true;
  newStack5[0].visible = true;
  newStack6[0].visible = true;
  newStack7[0].visible = true;
  let result = {
    deck: newDeck,
    stack_1: newStack1,
    stack_2: newStack2,
